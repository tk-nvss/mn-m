          ...
          html: `
            ...
            <head>
              ...
              <style>
                ...
                .container { max-width: 420px; margin: 20px auto; padding: 24px; background-color: #ffffff; border-radius: 12px; border: 1px solid #e2e8f0; }
                .header { display: flex; align-items: center; gap: 8px; margin-bottom: 16px; }
                .logo { height: 28px; width: auto; }
                .brand { font-weight: 800; font-size: 14px; color: #0f172a; }
                .banner { width: 100%; border-radius: 8px; margin-bottom: 16px; display: block; object-fit: cover; }
                .promo-title { font-size: 18px; font-weight: 800; color: #0f172a; margin: 0 0 10px 0; line-height: 1.3; }
                .content { font-size: 13px; color: #475569; white-space: pre-wrap; margin-bottom: 20px; line-height: 1.5; }
                .cta { display: block; text-align: center; background: #2563eb; color: #ffffff !important; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: 700; font-size: 13px; letter-spacing: 0.02em; }
